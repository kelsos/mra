...
BEGIN_EVENT_TABLE(AboutBox, wxDialog)
  EVT_BUTTON (ID_ABOUT_WXBUTTONOK, AboutBox::OnButtonOK)
END_EVENT_TABLE()

AboutBox::AboutBox(wxWindowID id)
  : wxDialog(NULL,id,wxT("About"),wxDefaultPosition, wxSize(480,450), wxDEFAULT_DIALOG_STYLE )
{

  //Writes the application name
  wxStaticText *myAppName = new wxStaticText(this, -1, wxT("Manga Reading Assistant"), wxPoint(10,10), wxSize(200,40), 0 );
  ...
  wxStaticText *myAppVersion = new wxStaticText(this, -1, versionString, wxPoint(10,myAppName->GetPosition().y+35), wxSize(200,40), 0);
  ...
  wxStaticText *myAppCopyright = new wxStaticText(this,-1,
      copyrightString,
      wxPoint(10,this->GetSize().y-100),
      wxSize(200,100),
      0,
      wxT("myAppCopyright"));
  ...
  //Writes build info
  wxStaticText *myAppInfo = new wxStaticText(this, -1, wxBuild, wxPoint(10,this->GetSize().y-70), wxSize(20,100), 0);
  ...
  //Static line
  wxStaticLine *myStaticLine = new wxStaticLine(this, -1, wxPoint(0,this->GetSize().y-80), wxSize(this->GetSize().x,2), wxLI_HORIZONTAL, wxT("staticLine"));
...
//---------------------------------------------------------------------------------------------------------
void
AboutBox::OnClose(wxCommandEvent&
                  WXUNUSED(event))
{
  EndModal( wxID_OK);
}
...
//---------------------------------------------------------------------------------------------------------
void
AboutBox::OnButtonOK(wxCommandEvent&
                     WXUNUSED(event))
{
  EndModal( wxID_OK);
}
